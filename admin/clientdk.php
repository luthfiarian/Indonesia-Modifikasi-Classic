        ...
        <section class="pt-28 pb-3">
            <div class="container">
                <div class="w-full px-4 mb-5 text-center">
                    <a href="clientdm.php" class="px-4 py-2 -mr-1.5 rounded-l-lg bg-primary shadow-lg font-semibold">Mobil</a>
                    <a href="" class="px-4 py-2 bg-dark text-white rounded-r-lg font-semibold">Kontruksi</a>
                </div>
