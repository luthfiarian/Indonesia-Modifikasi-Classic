                ...
                <div class="w-full px-4 bg-slate-200 border-l-2 border-slate-400">
                    ...
                    <form action="database/add.php" method="post">
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 mb-6 w-full group">
                                <input type="text" name="jenis" id="jenis" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="">
                            ...
                            <div class="w-full text-center mx-auto">
                                <input value="Daftarkan" name="daftar_ck" type="submit" class="py-2 px-6 font-semibold mb-10 bg-primary border-2 border-primary transition duration-300 hover:shadow-lg hover:opacity-80 rounded-3xl ease-in-out">
                            </div>
                        </div>
                    </form> 
                </div>
            ...
            <div class="container">
                <div class="w-full px-4">
                    <div class="mx-auto crd-atas text-center">
                        <a href="clientm.php" class="crd py-2 px-6 mx-auto mb-2 md:mb-10 font-semibold bg-primary border-2 border-primary transition duration-300 hover:shadow-2xl hover:opacity-80 rounded-3xl ease-in-out">Pemesanan Mobil</a>
                        <a href="" class="crd py-2 px-6 mx-auto mb-2 md:mb-10 font-semibold text-white bg-dark border-2 border-dark transition duration-300 hover:shadow-2xl hover:opacity-80 rounded-3xl ease-in-out">Pemesanan Kontruksi</a>
