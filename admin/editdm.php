                    ...
                    <form action="database/edit.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                ...
                                <div class="relative z-0 mb-6 w-full group">
                                    <input type="date" value="<?php echo $editm["cm_tanggalmasuk"]; ?>" name="tanggal" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer">
