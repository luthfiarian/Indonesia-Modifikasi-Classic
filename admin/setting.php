            ...
            <div class="container">
                <div class="w-full px-4 pb-10 bg-slate-200 border-l-2 border-slate-400">
                    ...
                    <table class="table table-auto mx-auto">
                        ...
                        <tr><td><br></td><td><br></td></tr>
                        <tr>
                            <td><a href="#" class="py-2 px-6 mx-auto mb-10 font-semibold bg-primary border-2 border-primary transition duration-300 hover:shadow-2xl hover:opacity-80 rounded-3xl ease-in-out">Lihat</a></td>
                            <td><a href="#" class="py-2 px-6 mx-auto mb-10 font-semibold text-white bg-red-500 border-2 border-red-500 transition duration-300 hover:shadow-2xl hover:opacity-80 rounded-3xl ease-in-out">Reset</a></td>
                        </tr>
                    </table>
                </div>
            </div>
