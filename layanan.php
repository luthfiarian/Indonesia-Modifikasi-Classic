...
<head>
    ...
    <meta name="title" content="Layanan Kami | IMC">
    <meta name="description" content="Disini layanan kami.">
...
<body>
    ...
    <content>
        <!-- Layanan Kami -->
        <section id="layanan_kami" class="pt-36 pb-5">
            <div class="container">
                <div class="w-full px-4">
                    <h2 class="text-center font-bold text-3xl mb-2 text-dark">Layanan Kami</h2>
                ...
                <div class="w-full px-4 flex flex-wrap justify-center">
                    <div class="mt-3 p-4 lg:w-1/2">
                        <img class="rounded-lg shadow-2xl w-full mx-auto" src="dist/img/layanan1.png">
                    </div>
                    <div class="p-4 lg:w-1/2">
                        ...
                        <p class="font-normal mb-3 text-justify">Proses yang dilakukan secara bertahap dengan menemui client berdiskusi untuk
                            ...
                            berapa lama prosesnya nya dan apa saja prosesnya. kami menyediakan website tracking pesanan agar client
                            dapat melihat proses modifikasi mobil dengan memasukkan nomer resi yang kami berikan.tanpa harus datang ke bengkel.
                            Jika client lupa dengan nomer resi tersebut maka kami akan memberikan Data dan nomer resi tersebut.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="pb-20 bg-gray-200">
            <div class="container">
                <div class="w-full px-4 flex flex-wrap">
                    <div class="p-4 lg:w-1/2">
                        <h2 class="font-semibold uppercase text-3xl lg:text-4xl mb-6">PT. Inti Maju Cemerlang</h2>
                        <p class="font-normal mb-5 text-justify">Didirikan pada akhir tahun 2010 berdasarkan akte notaris No : 13 tanggal 21 Maret 2012 dan disahkan
                            oleh Menteri Hukum dan Hak Asasi Manusia Republik Indonesia No : AHU-23016.AH.01.01. Tahun 2012 adapun bidang usahanya adalah</p>
                        <ul class="list-disc text-4xs ml-5">
                    ...
                    <div class="p-4 lg:w-1/2">
                        <img class="rounded-lg shadow-2xl mt-2 mx-auto" src="dist/img/layanan2.png">
                    </div>
                </div>
            </div>
        </section>
