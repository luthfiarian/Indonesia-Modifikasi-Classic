        ...
        <section class="pt-36 pb-32">
            <div class="container">
                <div class="w-full px-4">
                    <form action="" class="mx-auto bg-slate-500 border-slate-400 rounded-xl shadow-2xl xs:w-full sm:w-full md:w-1/3 lg:w-1/3 max-h-full" method="post">
                        ...
                        <input type="submit" value="Masuk" class="block mx-auto text-base font-semibold text-white bg-primary mt-4 mb-50 py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">
                        <div class="pb-8"></div>
                </div>
            </div>
        </section>
