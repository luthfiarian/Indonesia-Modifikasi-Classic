...
<head>
    ...
    <meta name="title" content="Profil | IMC">
    <meta name="description" content="Profil tentang kami.">
        ...
        <section id="profil" class="pt-36 pb-32">
            <div class="container">
                <div class="w-full px-4">
                    <!-- Profil PT IMC -->
                    <h2 class="font-bold text-2xl mb-3 text-dark text-center">PROFIL</h2>
                ...
                <div class="w-full px-4 flex flex-wrap justify-center">
                    <div class="mb-12 p-4 lg:w-1/2">
                        <h2 class="font-semibold  text-4xl lg:text-3xl mb-6 uppercase">PT. Inti Maju Cemerlang</h2>
                        <p class="text-lg mb-7 text-justify"> Didirikan pada akhir tahun 2010 berdasarkan akte notaris No : 13
                            tanggal 21 Maret 2012 dan disahkan oleh Menteri Hukum dan Hak Asasi Manusia Republik Indonesia
                            No : AHU-23016.AH.01.01. Tahun 2012 adapun bidang usahanya adalah</p>
                        <ul class=" text-4xs ">
                            <div class="flex-1 min-w-0">
                                <li>
                                    <div class="flex justify space-x-3">
                                        <img class="w-6 h-6 space-y-5" src="dist/img/home.png" alt="profile picture">
                                        <div class="mb-2 font-medium ">Pembangunan</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex justify space-x-3">
                                        <img class="w-6 h-6" src="dist/img/customer_service.png" alt="profile picture">
                                        <div class="mb-2 font-medium ">Jasa</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex justify space-x-3">
                                        <img class="w-6 h-6" src="dist/img/trade.png" alt="profile picture">
                                        <div class="mb-2 font-medium ">Perdagangan</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex justify space-x-3">
                                        <img class="w-6 h-6" src="dist/img/factory.png" alt="profile picture">
                                        <div class="mb-2 font-medium ">Perindustrian</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex justify space-x-3">
                                ...
                                <li>
                                    <div class="flex justify space-x-3">
                                        <img class="w-6 h-6" src="dist/img/planting.png" alt="profile picture">
                                        <div class="mb-2 font-medium ">Pertanian</div>
                                    </div>
                                </li>
                        </ul>
                    </div>
                    <div class="mt-20 pt-15 xl:w-1/2">
                        <img class="invisible md:visible" src="dist/img/profil1.png" alt="image description" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></img>
                    </div>
                </div>
                <div class="pb-1 w-full">
                    <img src="dist/img/hero.png" class="mx-auto -mt-80 md:mt-0" width="75%" alt="image description" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></img>
                </div>
            </div>
            <!-- end profile PT IMC -->
            ...
            <div class="mb-8 rounded-lg">
                <figure class="flex flex-col justify-center items-center px-8 py-16 text-center bg-gray-300 rounded-tr-lg">
                    <blockquote class="mx-auto mb-4 max-w-2xl lg:mb-8">
                        <div class="MISI">
                            <h2 class="font-bold text-2xl text-dark text-center">VISI</h2>
                        </div>
                ...
                <figure class="flex flex-col justify-center items-center p-8 text-center bg-white rounded-tr-lg">
                    <blockquote class="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                        <h2 class="font-bold text-2xl text-dark text-center">MISI</h2>
                        <hr class="w-24 border-b-2 mx-auto mb-3 mt-2 border-primary rounded-full">
                        <ul class="list-inside text-black text-lg font-semibold text-center">
                            ...
                            <li>
                                Menjadi Tempat Untuk Berprestasi Mengembangkan Diri Bagi Karyawan
                            </li>
                            <li>
                                Menjadi Asset Yang Berharga Dan Membanggakan Bagi Masyarakat Dan Bangsa
                            </li>
                        </ul>
                    </blockquote>
                </figure>
            ...
            <!-- END VISI MISI -->
            <div class="w-full px-4">
                <h2 class="font-bold text-2xl mb-3 text-dark text-center">Cek Youtube Kami</h2>
                <hr class="w-24 border-b-2 mx-auto mb-3 mt-1 border-primary rounded-full">
            </div>
